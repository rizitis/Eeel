...
load_env_vars('/etc/eeel/eeel.env') # Must edit repo there for ponce if slpkg is on ponce repo.
...
class CommandPanel(QWidget):
    def __init__(self, commands):
        ...
        # Button to search for the SlackBuild folder locally
    ...
    def search_folder(self):
        ...
        repo_name = os.getenv('SLAKCBUILDS_REPO', 'sbo')  # Use 'sbo' as the default
        if repo_name != 'sbo':
            search_path = f"/var/lib/slpkg/repos/{repo_name}"  # Use the environment variable if it's not 'sbo'
        else:
            search_path = "/var/lib/slpkg/repos/sbo"  # Default to 'sbo'
...
class NewSection(QWidget):
    def __init__(self):
        ...
        example_pixmap = QPixmap("/usr/share/pixmaps/eeel/icons/eel2.png")
...
class AdditionalSection(QWidget):
    def __init__(self):
        ...
        # Define your command templates
        self.commands = [
            ("Update", "slpkg -u"),  # Command for Update all repos
            ("Upgrade", "slpkg -U")   # Command for Upgrade only default repo supposed its sbo or ponce
        ]
    ...
    def execute_command(self, command):
        try:
            # Use konsole to run the command, change it with xfce4-terminal or xterm if you like...
...
class MainWindow(QMainWindow):
    def __init__(self, images):
        ...
        self.setWindowTitle("Electric Eel")
        ...
        commands = [
            ...
            ("List deps", "slpkg -t {input}", False),
            ("List depentees on", "slpkg -e {input}", False)
        ]
...
def main():
    ...
    repo_name = os.getenv('SLAKCBUILDS_REPO', 'sbo')

    # Define the base path for images
    base_path = f'/var/lib/slpkg/repos/{repo_name}'

    images = [
        (f'/usr/share/pixmaps/eeel/icons/academic.png', f'{base_path}/academic', 'Academic'),
        (f'/usr/share/pixmaps/eeel/icons/accessibility.png', f'{base_path}/accessibility', 'Accessibility'),
        (f'/usr/share/pixmaps/eeel/icons/audio.png', f'{base_path}/audio', 'Audio'),
        (f'/usr/share/pixmaps/eeel/icons/business.png', f'{base_path}/business', 'Business'),
        (f'/usr/share/pixmaps/eeel/icons/desktop.png', f'{base_path}/desktop', 'Desktop'),
        (f'/usr/share/pixmaps/eeel/icons/development.png', f'{base_path}/development', 'Development'),
        (f'/usr/share/pixmaps/eeel/icons/games.png', f'{base_path}/games', 'Games'),
        (f'/usr/share/pixmaps/eeel/icons/gis.png', f'{base_path}/gis', 'GIS'),
        (f'/usr/share/pixmaps/eeel/icons/graphics.png', f'{base_path}/graphics', 'Graphics'),
        (f'/usr/share/pixmaps/eeel/icons/ham.png', f'{base_path}/ham', 'Ham'),
        (f'/usr/share/pixmaps/eeel/icons/haskell.png', f'{base_path}/haskell', 'Haskell'),
        (f'/usr/share/pixmaps/eeel/icons/libraries.png', f'{base_path}/libraries', 'Libraries'),
        (f'/usr/share/pixmaps/eeel/icons/misc.png', f'{base_path}/misc', 'Misc'),
        (f'/usr/share/pixmaps/eeel/icons/mutlimedia.png', f'{base_path}/multimedia', 'Multimedia'),
        (f'/usr/share/pixmaps/eeel/icons/network.png', f'{base_path}/network', 'Network'),
        (f'/usr/share/pixmaps/eeel/icons/office.png', f'{base_path}/office', 'Office'),
        (f'/usr/share/pixmaps/eeel/icons/perl.png', f'{base_path}/perl', 'Perl'),
        (f'/usr/share/pixmaps/eeel/icons/python.png', f'{base_path}/python', 'Python'),
        (f'/usr/share/pixmaps/eeel/icons/ruby.png', f'{base_path}/ruby', 'Ruby'),
        (f'/usr/share/pixmaps/eeel/icons/system.png', f'{base_path}/system', 'System'),
    ]
